...
def process_directory(
        wav_dir, text_dir, output_dir, output_sr, language, speaker_id, num_workers, batch_size):
    """
    ...
    print(
        f"{os.path.basename(wav_dir)} - Processed: {processed_count}, Skipped: {skipped_count}, Errors: {error_count}"
    )
    return data_entries
