...
from stylettsplus.utils.asr.models import ASRCNN
from stylettsplus.utils.jdc.model import JDCNet

from stylettsplus.modules.diffusion.sampler import KDiffusion, LogNormalDistribution
from stylettsplus.modules.diffusion.modules import Transformer1d, StyleTransformer1d
from stylettsplus.modules.diffusion.diffusion import AudioDiffusionConditional

from stylettsplus.modules.discriminators import MultiPeriodDiscriminator, MultiResSpecDiscriminator, WavLMDiscriminator
...
class ResBlk1d(nn.Module):
    ...
    def __init__(
            self, dim_in, dim_out, actv=nn.LeakyReLU(0.2), normalize=False, downsample='none', dropout_p=0.2):
        super().__init__()
        self.actv = actv
        self.normalize = normalize
...
def build_model(args, text_aligner, pitch_extractor, bert):
    ...
    if args.decoder.type == "istftnet":
        from stylettsplus.modules.istftnet import Decoder
        decoder = Decoder(
        ...
        from stylettsplus.modules.hifigan import Decoder
        decoder = Decoder(
            dim_in=args.hidden_dim,
            style_dim=args.style_dim,
            dim_out=args.n_mels,
    ...
    diffusion.diffusion = KDiffusion(
        ...
        sigma_data=args.diffusion.dist.
        sigma_data,  # a placeholder, will be changed dynamically when start training diffusion model
